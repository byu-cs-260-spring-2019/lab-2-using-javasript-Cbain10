    ...
    document.getElementById("weatherSubmit").addEventListener("click", async function(event) {
        ...
        fetch(url2)
            ...
            for (let i=0; i < 6; i++) {
                ...
                forecast1 += '<img src="http://openweathermap.org/img/w/' + json.list[i].weather[0].icon + '.png"/></div>'
            ...
            for (let i=6; i < 14; i++) {
                ...
                forecast2 += '<img src="http://openweathermap.org/img/w/' + json.list[i].weather[0].icon + '.png"/></div>'
            ...
            for (let i=14; i < 22; i++) {
                ...
                forecast3 += '<img src="http://openweathermap.org/img/w/' + json.list[i].weather[0].icon + '.png"/></div>'
            ...
            for (let i=22; i < 30; i++) {
                ...
                forecast4 += '<img src="http://openweathermap.org/img/w/' + json.list[i].weather[0].icon + '.png"/></div>'
            ...
            for (let i=30; i < 38; i++) {
                ...
                forecast5 += '<img src="http://openweathermap.org/img/w/' + json.list[i].weather[0].icon + '.png"/></div>'
            ...
            for (let i=38; i < 40; i++) {
                ...
                forecast6 += '<img src="http://openweathermap.org/img/w/' + json.list[i].weather[0].icon + '.png"/></div>'
